        ...
        >
          <div className="flex items-center gap-2.5">
            <div className="relative flex h-7 w-7 shrink-0">
              ...
              <span className="relative inline-flex rounded-full h-7 w-7 bg-green-500 items-center justify-center text-white text-2xs font-bold">
                {current.name[0]}
              </span>
            </div>
            <div className="text-xs">
              ...
              <p className="text-slate-500 dark:text-slate-400 text-2xs">{current.action}</p>
            </div>
          </div>
        </motion.div>
      )}
