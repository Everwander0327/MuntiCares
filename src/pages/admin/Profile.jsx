...
const QuickStat = ({ label, value, icon, color }) => {
  ...
  return (
    <div className="text-center p-4 md:p-6">
      ...
      <p className="text-2xl md:text-3xl font-bold text-slate-900" ref={ref}>{count}</p>
      <p className="text-xs md:text-sm text-slate-500 font-medium mt-1">{label}</p>
    </div>
  );
};
        ...
        >
          ...
          <div className="px-6 md:px-8 -mt-16 md:-mt-18 relative z-10 flex justify-center">
            <div className="relative">
              <div className="w-28 h-28 md:w-32 md:h-32 rounded-full bg-white border-4 border-white shadow-xl flex items-center justify-center text-4xl md:text-5xl font-bold text-slate-700"
          ...
          <div className="px-6 md:px-8 pt-5 text-center">
            <h2 className="text-2xl md:text-3xl font-bold text-slate-900">{profile.full_name}</h2>
            ...
            <div className="flex items-center justify-center flex-wrap gap-2 mt-3">
              <span className="inline-flex items-center gap-1.5 px-4 py-1.5 bg-slate-100 text-slate-700 font-bold text-xs uppercase tracking-widest rounded-full border border-slate-200">
          ...
          {/* Quick Stats */}
          <div className="mx-6 md:mx-8 mt-8 border border-slate-100 rounded-2xl overflow-hidden bg-slate-50/50">
