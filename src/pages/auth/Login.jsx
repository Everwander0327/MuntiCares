...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900 flex items-center justify-center p-6 pt-32 pb-20 relative overflow-hidden">
      ...
      <motion.div 
        className={`relative z-10 w-full max-w-md rounded-[2.5rem] p-8 md:p-10 border border-white/50 dark:bg-slate-900/80 dark:border-slate-700 bg-white/80 ${shake ? 'animate-shake' : ''}`}
        style={{
